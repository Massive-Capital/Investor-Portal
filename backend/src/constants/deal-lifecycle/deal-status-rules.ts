...
} from "./deal-stage-status-map.js";
import { defaultStatusForStage } from "./default-stage-status.js";
import {
...
/** Reconcile status when stage changes; keeps status if still valid, else default. */
...
/** Soft/hard commitment → full investment: notify existing investors to complete. */
