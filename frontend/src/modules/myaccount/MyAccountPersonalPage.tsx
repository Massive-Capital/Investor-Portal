...
import { AtSign, Eye, Loader2, Mail, Phone, Save, User } from "lucide-react"
...
function visibleToUsersChoiceFromUser(u: Record<string, unknown>): VisibleToUsersChoice {
  return u.visibleToUsers === true || u.visible_to_users === true ? "yes" : "no"
}
...
export function MyAccountPersonalPage() {
  ...
  const [visibleToUsers, setVisibleToUsers] = useState<VisibleToUsersChoice>("no")
  ...
  const [initialValues, setInitialValues] = useState({
    ...
    phoneNationalDigits: "",
    username: "",
    visibleToUsers: "no" as VisibleToUsersChoice,
  })
  ...
  const loadFromSession = useCallback(() => {
    ...
    const showVisibility = canSetPlatformVisibility(u)
    setFirstName(first)
    setLastName(last)
    setPhoneNationalDigits(phoneNat)
    setUsername(accountName)
    setShowVisibleToUsers(showVisibility)
  ...
  const hasChanges = useMemo(() => {
    ...
    return (
      ...
      (showVisibleToUsers && visibleToUsers !== initialValues.visibleToUsers)
    )
  }, [
    firstName,
    lastName,
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (
        ...
        patch.visibleToUsers = visibleToUsers === "yes"
      }
  ...
  if (isLoading) return <MyAccountPanelLoader label="Loading personal details…" />
  ...
  return (
    <div className="myaccount_form_body myaccount_form_body--grid">
      ...
      <form
        ref={personalFormRef}
        className="myaccount_fields_grid"
        onSubmit={handleSubmit}
        noValidate
      >
        <div className="myaccount_fields_grid_fields">
