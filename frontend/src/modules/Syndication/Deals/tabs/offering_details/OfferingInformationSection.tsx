          ...
          <div className="deal_inv_class_field">
            ...
            <div className="deal_inv_ic_pct_row">
              <input
                ...
                onChange={(e) =>
                  patchAdvanced({
                    entityLegalOwnershipPct: sanitizePercentTypingInput(
                      e.target.value,
                    ),
                  })
                }
                onBlur={(e) =>
                  patchAdvanced({
                    entityLegalOwnershipPct: blurFormatPercentTwoDecimalsInput(
                      e.target.value,
                    ),
                  })
                }
        ...
        <>
          <div className="deal_inv_class_field">
            ...
            <input
              ...
              onChange={(e) => {
                onClearError?.()
                setForm({
                  offeringSize: sanitizeMoneyTypingInput(e.target.value),
                })
              }}
              onBlur={(e) =>
          ...
          <div className="deal_inv_class_field">
            ...
            <input
              ...
              onChange={(e) => {
                onClearError?.()
                setForm({
                  raiseAmountDistributions: sanitizeMoneyTypingInput(
                    e.target.value,
                  ),
                })
              }}
          ...
          <div className="deal_inv_class_field">
            ...
            <input
              ...
              onChange={(e) =>
                setForm({
                  billingRaiseQuota: sanitizeMoneyTypingInput(e.target.value),
                })
              }
              onBlur={(e) =>
                setForm({
          ...
          <div className="deal_inv_class_field">
            ...
            <input
              ...
              onChange={(e) => {
                onClearError?.()
                setForm({
                  minimumInvestment: sanitizeMoneyTypingInput(e.target.value),
                })
              }}
              onBlur={(e) =>
                setForm({
          ...
          <div className="deal_inv_ic_advanced_um_grid">
            <section className="deal_inv_ic_adv_group">
              ...
              <div className="deal_inv_ic_adv_group_grid">
                ...
                {isMezzanineLayout ? (
                  <div
                    className="um_field add_contact_field_tight deal_inv_ic_advanced_um_spacer deal_inv_ic_adv_field"
                    aria-hidden
                  />
                ) : null}
              </div>
              ...
              <section className="deal_inv_ic_adv_group">
                ...
                <div className="deal_inv_ic_pct_row">
                  <input
                    ...
                    onChange={(e) =>
                      patchAdvanced({
                        distributionSharePct: sanitizePercentTypingInput(
                          e.target.value,
                        ),
                      })
                    }
                    onBlur={(e) =>
                      patchAdvanced({
                        distributionSharePct: blurFormatPercentTwoDecimalsInput(
                          e.target.value,
                        ),
                      })
                    }
            ...
            <section className="deal_inv_ic_adv_group">
              ...
              <input
                ...
                onChange={(e) =>
                  patchAdvanced({
                    maximumInvestment: sanitizeMoneyTypingInput(e.target.value),
                  })
                }
                onBlur={
                  isGpLayout
              ...
              />
                ...
                {!isGpLayout ? (
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setForm({
                        pricePerUnit: sanitizeMoneyTypingInput(e.target.value),
                      })
                    }
                    onBlur={(e) =>
                      setForm({
