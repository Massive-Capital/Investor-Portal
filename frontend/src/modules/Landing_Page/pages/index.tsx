...
export default function LandingPage() {
  ...
  /** Opacity only — no transform on this wrapper so inner `position: sticky` navbar still works. */
  ...
  /**
   * Main + footer: opacity only. Avoids parent `transform` fighting Hero’s own motion
   * (compound transforms read as jittery / “not smooth”).
   */
  ...
  // Ambient stays outside the transformed reveal layer so `position: fixed` orbs stay viewport-locked.
  return (
